...
class _HomePageState extends State<SellerHomePage> with AutomaticKeepAliveClientMixin {
  File? _profileImage;
  String name = "";
  String email = "";
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: Text("Select from Gallery", style: Theme.of(context).textTheme.bodyLarge),
                onTap: () {
              ...
              ListTile(
                ...
                title: Text("Capture from Camera", style: Theme.of(context).textTheme.bodyLarge),
                onTap: () {
                  Navigator.pop(context);
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      leading: Icon(Icons.delivery_dining, color: Theme.of(context).iconTheme.color),
                      title: Text('Manage Orders', style: Theme.of(context).textTheme.bodyLarge),
                      onTap: () {
                        Navigator.push(
                          context,
                    ...
                    ListTile(
                      leading: Icon(Icons.people_alt_outlined, color: Theme.of(context).iconTheme.color),
                      title: Text('Rent Requests', style: Theme.of(context).textTheme.bodyLarge),
                      onTap: () {
